			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Advanced Skin Clinic</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Advanced Skin Clinic</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://advancedskinclinic.in/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
